...
class Stream extends Thread {
    ...
    void sendFocusData() {
        ...
        //float metric_Value= (float)w_focus.updateFocusState();
        //float metric_Value= w_focus.metric_value_obj.update();
        float metric_Value= w_focus.metric_value_obj.POPOPO;
        //
