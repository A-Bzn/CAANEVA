...
class W_Focus extends Widget {
    ...
    public MetricValueGetter metric_value_obj;
    ...
    W_Focus(PApplet _parent) {
        ...
        metric_value_obj= new MetricValueGetter();
    ...
    public double updateFocusState() {
        try {
            ...
            metric_value_obj.update((float)prediction);/// C'est bon plus qu'à récupérer
